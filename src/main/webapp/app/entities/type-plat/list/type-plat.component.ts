...
import { EntityArrayResponseType, TypePlatService } from '../service/type-plat.service';
...
export class TypePlatComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITypePlat): number => this.typePlatService.getTypePlatIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.typePlats = this.refineData(dataFromBody);
  }

  protected refineData(data: ITypePlat[]): ITypePlat[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: ITypePlat[] | null): ITypePlat[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.typePlatService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
